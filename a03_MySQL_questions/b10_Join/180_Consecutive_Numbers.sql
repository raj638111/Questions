...
-- Solution 1 (Using Inner Join) > 95%
...
-- Solution 2 (Using Cross Join) > 45%
...
-- Solution 3 (Using subquery in where); > 27%

select distinct l1.Num as ConsecutiveNums
from
Logs l1
where (
  (select count(*) from Logs l2 where l2.Id in (l1.Id + 1, l1.Id + 2)
   and l2.Num = l1.Num)
) = 2


-- Solution 4 (Using Subquery in where) > 5%
